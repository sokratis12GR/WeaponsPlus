...
public class ObsidianBow extends ItemBow {
    ...
    public ObsidianBow() {
        ...
        setRegistryName("ObsidianBow");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "ObsidianBow", "inventory"));
    }
