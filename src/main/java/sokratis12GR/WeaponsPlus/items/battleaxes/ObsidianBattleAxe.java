 ...
 */
public class ObsidianBattleAxe extends ItemSword {


    public ObsidianBattleAxe(Item.ToolMaterial material) {
        super(material);
        setRegistryName("ObsidianBattleAxe");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName("ObsidianBattleAxe");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "ObsidianBattleAxe", "inventory"));
    }
