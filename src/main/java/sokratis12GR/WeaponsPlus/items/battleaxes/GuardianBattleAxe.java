...
public class GuardianBattleAxe extends ItemSword {
    ...
    public GuardianBattleAxe(Item.ToolMaterial material) {
        super(material);
        setRegistryName("GuardianBattleAxe");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "GuardianBattleAxe", "inventory"));
    }
