...
public class EmeraldBattleAxe extends ItemSword {
    ...
    public EmeraldBattleAxe(Item.ToolMaterial material) {
        super(material);
        setRegistryName("EmeraldBattleAxe");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "EmeraldBattleAxe", "inventory"));
    }
