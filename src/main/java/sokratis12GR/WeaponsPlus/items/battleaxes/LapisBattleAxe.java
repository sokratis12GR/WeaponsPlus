...
public class LapisBattleAxe extends ItemSword {
    ...
    public LapisBattleAxe(Item.ToolMaterial material) {
        super(material);
        setRegistryName("LapisBattleAxe");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "LapisBattleAxe", "inventory"));
    }
