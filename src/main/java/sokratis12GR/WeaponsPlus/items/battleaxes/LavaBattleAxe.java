...
public class LavaBattleAxe extends ItemSword {
    ...
    public LavaBattleAxe(Item.ToolMaterial material) {
        super(material);
        setRegistryName("LavaBattleAxe");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "LavaBattleAxe", "inventory"));
    }
