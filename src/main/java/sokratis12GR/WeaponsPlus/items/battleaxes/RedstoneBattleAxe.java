...
public class RedstoneBattleAxe extends ItemSword {
    ...
    public RedstoneBattleAxe(Item.ToolMaterial material) {
        super(material);
        setRegistryName("RedstoneBattleAxe");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName("RedstoneBattleAxe");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "RedstoneBattleAxe", "inventory"));
    }
