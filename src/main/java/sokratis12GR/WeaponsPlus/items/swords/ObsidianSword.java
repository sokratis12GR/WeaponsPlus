...
public class ObsidianSword extends ItemSword {
    ...
    public ObsidianSword(ToolMaterial material) {
        super(material);
        setRegistryName("ObsidianSword");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "ObsidianSword", "inventory"));
    }
