...
public class CoalSword extends ItemSword {
    ...
    public CoalSword(ToolMaterial material) {
        super(material);
        setRegistryName("CoalSword");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "CoalSword", "inventory"));
    }
