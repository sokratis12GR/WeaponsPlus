...
public class RedstoneSword extends ItemSword {
    ...
    public RedstoneSword(ToolMaterial material) {
        super(material);
        setRegistryName("RedstoneSword");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "RedstoneSword", "inventory"));
    }
