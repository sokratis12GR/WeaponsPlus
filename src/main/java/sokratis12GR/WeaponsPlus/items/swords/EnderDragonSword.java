...
public class EnderDragonSword extends ItemSword {
    ...
    public EnderDragonSword(ToolMaterial material) {
        super(material);
        setRegistryName("EnderDragonSword");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "EnderDragonSword", "inventory"));
    }
