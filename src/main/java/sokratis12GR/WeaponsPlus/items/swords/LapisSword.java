...
public class LapisSword extends ItemSword {
    ...
    public LapisSword(ToolMaterial material) {
        super(material);
        setRegistryName("LapisSword");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "LapisSword", "inventory"));
    }
