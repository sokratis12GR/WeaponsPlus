...
public class SuperStarSword extends ItemSword {
    ...
    public SuperStarSword(ToolMaterial material) {
        super(material);
        setRegistryName("SuperStarSword");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(WeaponsPlus.MODID + ":" + "SuperStarSword", "inventory"));
    }
